...
- **Currency Support**: Configured to use **INR (Indian Rupee)** for all price monitoring and alerts.
...
3.  **Currency**: The system is now explicitly configured to request and display prices in **INR**.
...
- `flight_tracker/`: Core package containing the application logic.
  ...
  - `flight_search.py`: Handles API interactions and currency configuration (INR).
